    ...
    <div class="container">
        ...
        <form action="create" method="post">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="kode_akun" size="20" maxlength="4" required min="0"/>
            </div>

            <div class="form-group">
                <label for="nama_akun"><?php echo $model->labels['nama_akun']; ?></label>
                <input type="text" class="form-control" name="nama_akun" size="30" maxlength="25" />
            </div>
